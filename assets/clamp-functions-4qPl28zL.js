...
.content {
  ...
  `}function t(){const e=document.getElementById("cf-resize"),i=document.getElementById("cf-inner"),a=document.getElementById("cf-label");if(!e||!i||!a)return;new ResizeObserver(c=>{for(const r of c){const s=Math.round(r.contentRect.width),o=Math.round(i.getBoundingClientRect().width);a.textContent=`Container: ${s}px → Inner: ${o}px`}}).observe(e)}export{t as init,l as render};
