...
/* Available syntax types:
  ...
  `}function i(){const e=document.getElementById("ap-progress"),a=document.getElementById("ap-fill-btn"),r=document.getElementById("ap-reset-btn"),o=document.getElementById("ap-counter"),n=document.getElementById("ap-count-btn");a&&e&&a.addEventListener("click",()=>{e.classList.add("filled");const t=e.querySelector(".ap-progress-label");t&&(t.textContent="75%")}),r&&e&&r.addEventListener("click",()=>{e.classList.remove("filled");const t=e.querySelector(".ap-progress-label");t&&(t.textContent="0%")}),n&&o&&n.addEventListener("click",()=>{o.classList.toggle("counting")})}export{i as init,s as render};
