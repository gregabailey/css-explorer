...
.grid {
  ...
  `}function s(){const e=document.getElementById("mf-slider"),d=document.getElementById("mf-snap-box"),a=document.getElementById("mf-val");!e||!d||!a||e.addEventListener("input",()=>{const i=parseInt(e.value),r=50,o=Math.round(i/r)*r;d.style.width=o+"px",d.textContent=o+"px",a.textContent=`round(${i}px, ${r}px) = ${o}px`})}export{s as init,l as render};
