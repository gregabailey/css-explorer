...
.bg-image {
  ...
  `}function m(){const t=document.getElementById("vu-show-bar"),o=document.getElementById("vu-hide-bar"),r=document.getElementById("vu-url-bar"),s=document.getElementById("vu-svh-box"),i=document.getElementById("vu-dvh-box"),a=document.getElementById("vu-lvh-box");if(!t||!o||!r)return;const l="105px",c="105px",v="130px",n="105px",h="130px",u="130px";function d(e){r.classList.toggle("hidden",!e),t.classList.toggle("active",e),o.classList.toggle("active",!e),e?(s.style.height=l,i.style.height=c,a.style.height=v):(s.style.height=n,i.style.height=h,a.style.height=u)}t.addEventListener("click",()=>d(!0)),o.addEventListener("click",()=>d(!1)),d(!0)}export{m as init,p as render};
