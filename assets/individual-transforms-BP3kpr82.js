...
.card-old:hover {
  ...
  `}function o(){const e=document.getElementById("it-translate"),t=document.getElementById("it-rotate"),a=document.getElementById("it-scale");document.getElementById("it-toggle-translate")?.addEventListener("click",()=>{e?.classList.toggle("translate-active")}),document.getElementById("it-toggle-rotate")?.addEventListener("click",()=>{t?.classList.toggle("rotate-active")}),document.getElementById("it-toggle-scale")?.addEventListener("click",()=>{a?.classList.toggle("scale-active")})}export{o as init,i as render};
