...
@container card-container (min-width: 600px) {
  ...
  `}function c(){const e=document.getElementById("cq-wrapper"),r=document.getElementById("cq-size-label");if(!e||!r)return;new ResizeObserver(a=>{for(const i of a)r.textContent=`Container width: ${Math.round(i.contentRect.width)}px`}).observe(e)}export{c as init,t as render};
