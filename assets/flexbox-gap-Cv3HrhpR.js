...
.tag-cloud {
  ...
  `}function d(){const a=document.getElementById("fg-slider"),e=document.getElementById("fg-label"),s=document.getElementById("fg-demo-row");!a||!e||!s||a.addEventListener("input",()=>{const i=a.value+"px";e.textContent=i,s.style.setProperty("--fg-gap",i)})}export{d as init,r as render};
