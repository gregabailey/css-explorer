...
.grid-child {
  ...
  `}function w(){const l=document.getElementById("txw-wrap-controls"),o=document.getElementById("txw-wrap-result");l&&o&&l.addEventListener("click",e=>{const t=e.target.closest(".btn");if(!t)return;l.querySelectorAll(".btn").forEach(r=>r.classList.remove("active")),t.classList.add("active");const a=t.dataset.prop;o.style.overflowWrap="",o.style.wordBreak="",a==="overflow-wrap: break-word"?o.style.overflowWrap="break-word":a==="overflow-wrap: anywhere"?o.style.overflowWrap="anywhere":a==="word-break: break-all"&&(o.style.wordBreak="break-all")});const n=document.getElementById("txw-ellipsis-toggles"),i=document.getElementById("txw-ellipsis-demo");if(n&&i){let t=function(){i.style.overflow=e.overflow?"hidden":"visible",i.style.whiteSpace=e["white-space"]?"nowrap":"normal",i.style.textOverflow=e["text-overflow"]?"ellipsis":"clip"};const e={overflow:!0,"white-space":!0,"text-overflow":!0};n.addEventListener("click",a=>{const r=a.target.closest(".txw-toggle");if(!r)return;const s=r.dataset.prop;e[s]=!e[s],r.classList.toggle("active",e[s]),r.classList.toggle("off",!e[s]),t()})}const d=document.getElementById("txw-clamp-controls"),c=document.getElementById("txw-clamp-demo");d&&c&&d.addEventListener("click",e=>{const t=e.target.closest(".txw-toggle");t&&(d.querySelectorAll(".txw-toggle").forEach(a=>a.classList.remove("active")),t.classList.add("active"),c.style.webkitLineClamp=t.dataset.lines)})}export{w as init,p as render};
