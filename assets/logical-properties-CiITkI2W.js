function i(){return`
  ...
  `}function l(){const d=document.getElementById("lp-demo"),e=document.getElementById("lp-ltr-btn"),t=document.getElementById("lp-rtl-btn");!d||!e||!t||(e.addEventListener("click",()=>{d.dir="ltr",e.classList.add("active"),t.classList.remove("active")}),t.addEventListener("click",()=>{d.dir="rtl",t.classList.add("active"),e.classList.remove("active")}))}export{l as init,i as render};
